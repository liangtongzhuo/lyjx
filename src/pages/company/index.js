...
import { View, Swiper, SwiperItem, AtDivider } from 'taro-ui'
  ...
  render() {
    return (
      <View className="home">
        ...
        <View decode space className="company-profile">
          &nbsp;&nbsp;洛阳晟尊机械设备有限公司是一家集科研开发、制造、销售、服务为一体的现代化企业。位于洛阳涧西区先进制造业集聚区。公司成立至今，始终坚持以人为本、质量第一、自主创新、持续改进，以技术领先求发展的方针。公司过了ISO9001 等国际质量体系、计量、设计规范等认证，属于高新技术企业。<br/><br/>
